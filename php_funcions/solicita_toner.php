<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (isset($_POST['id_toner_usado_sol'], $_POST['tecnico'], $_POST['cod_centermaq'], $_POST['dt_pedido_sol'])) {
            $id_toner = $_POST['id_toner_usado_sol'];
            ...
            $stmt = $db->prepare("UPDATE mov_toner SET status = 'Solicitado', tecnico = '$tecnico', cod_centermaq = '$cod_centermaq', dtped_centermaq = '$dt_pedido' WHERE id_mov_toner = '$id_toner';");
            $stmt->execute();
