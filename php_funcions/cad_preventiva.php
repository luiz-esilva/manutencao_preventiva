...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['computador'], $_POST['tecnico'], $_POST['data_realizado'])) {
        ...
        if ($imagem_antes_salva && $imagem_patrimonio_salva) {
            ...
            $stmt = $db->prepare('INSERT INTO "reg_preventiva" (id_computadores, tecnico, imagem_antes, imagem_patrimonio, data_realizado) VALUES (:computador, :tecnico, :img_antes, :img_patrimonio, :data_realizado)');
            ...
            header('Refresh: 0; URL=../reg_preventiva.php');
            exit();
        } else {
