<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (isset($_POST['id_drum_receb'], $_POST['tecnico'], $_POST['dt_saida'])) {
            ...
            $stmt = $db->prepare("UPDATE mov_unid_imagem SET status = 'Entregue Centermaq', tecnico = '$tecnico', dt_saida = '$dt_saida' WHERE id_mov_unidimagem = '$id_drum';");
            $stmt->execute();
