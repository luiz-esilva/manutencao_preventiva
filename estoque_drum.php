...
<head>
    ...
    <title>Manutenções Preventivas TI/HUA - Estoque Drum</title>
    ...
    <body>
            ...
            <div class='modal-dialog modal-dialog-centered'>
                    <div class='modal-content'>
                        <div class='modal-header'>
                            <h1 class='modal-title fs-5' id='modalNobreakLabel'>Recebimento de Drum</h1>
        ...
        <div class='modal fade' id='modalUsoToner' tabindex='-1' aria-labelledby='modalUsoTonerLabel' aria-hidden='true'>
            <div class='modal-dialog modal-dialog-centered'>
                    <div class='modal-content'>
                        <div class='modal-header'>
                            <h1 class='modal-title fs-5' id='modalNobreakLabel'>Uso de Drum</h1>
                            <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                        </div>
                            ...
                            <div class='modal-body'>
                                <div class="container-fluid">
                                    <div class="row" style="margin-bottom: 5px;">
                                        ...
                                        <input type="text" class="form-control" name="id_drum_usado" id="id_drum_usado" readonly>
                                    </div>
                                    <div class="row" style="margin-bottom: 5px;">
                                        <label for="tecnico" style="padding-left: 4px;font-weight: 500;">Técnico</label>
                                        <?php
        ...
        <div class='modal fade' id='modalEntregar' tabindex='-1' aria-labelledby='modalEntregarLabel' aria-hidden='true'>
            <div class='modal-dialog modal-dialog-centered'>
                    <div class='modal-content'>
                        <div class='modal-header'>
                            <h1 class='modal-title fs-5' id='modalEntregarLabel'>Entrega de Drum para Centermaq</h1>
                            <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                        </div>
                        <form action="./php_funcions/entregar_drum.php" method="POST" enctype="multipart/form-data">
                            <div class='modal-body'>
                                <div class="container-fluid">
                                    <div class="row" style="margin-bottom: 5px;">
        ...
        <div class='modal fade' id='modalSolicita' tabindex='-1' aria-labelledby='modalSolicitaLabel' aria-hidden='true'>
            <div class='modal-dialog modal-dialog-centered'>
                    <div class='modal-content'>
                        <div class='modal-header'>
                            <h1 class='modal-title fs-5' id='modalSolicitaLabel'>Solicitação de Drum</h1>
                            <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                        </div>
                        <form action="./php_funcions/solicita_drum.php" method="POST" enctype="multipart/form-data">
                            <div class='modal-body'>
                                <div class="container-fluid">
                                    <div class="row" style="margin-bottom: 5px;">
                    ...
                    <table class="table table-hover align-middle text-center table-bordered table-sm">
                        ...
                        <tbody>
                            <?php
                                ...
                                $dados = $db->query("SELECT mt.id_mov_unidimagem, mt.tecnico, mt.dt_entrada, mt.status, ip.nome_impressora, ip.nserie, ip.ip FROM mov_unid_imagem mt LEFT JOIN impressoras ip on ip.id_impressora = mt.id_impressora WHERE mt.status = 'Em Uso';");
                                while ($row = $dados->fetchArray()) {
                                    echo "<tr>";
                                    $id_toner = $row['id_mov_unidimagem'];
                                    echo "<td>$id_toner</td>";
                    ...
                    <table class="table table-hover align-middle text-center table-bordered table-sm">
                        ...
                        <tbody>
                            <?php
                                ...
                                $dados = $db->query("SELECT id_mov_unidimagem, tecnico, dt_entrada, status FROM mov_unid_imagem WHERE status = 'Em Estoque';");
                                while ($row = $dados->fetchArray()) {
                                    echo "<tr>";
                                    $id_toner = $row['id_mov_unidimagem'];
                                    echo "<td>$id_toner</td>";
                    ...
                    <table class="table table-hover align-middle text-center table-bordered table-sm">
                        ...
                        <tbody>
                            <?php
                                ...
                                $dados = $db->query("SELECT mt.id_mov_unidimagem, mt.tecnico, mt.dt_entrada, mt.status, ip.nome_impressora, ip.nserie FROM mov_unid_imagem mt LEFT JOIN impressoras ip on ip.id_impressora = mt.id_impressora WHERE mt.status = 'A Solicitar';");
                                while ($row = $dados->fetchArray()) {
                                    echo "<tr>";
                                    $id_toner = $row['id_mov_unidimagem'];
                                    echo "<td>$id_toner</td>";
                                    ...
                                    echo "<td>$row[nome_impressora]</td>";
                                    echo "<td>$row[nserie]</td>";
                                    echo "<td><button class='botao_personalizado' onclick=\"Solicitar('$id_toner')\" data-bs-toggle='modal' data-bs-target='#modalSolicita'><img src='bootstrap-icons-1.11.2/basket2.svg' width='30' height='30'></button></td>";
                                    echo "</tr>";
                                }
                    ...
                    <table class="table table-hover align-middle text-center table-bordered table-sm">
                        ...
                        <tbody>
                            <?php
                                ...
                                $dados = $db->query("SELECT mt.id_mov_unidimagem, mt.tecnico, mt.dt_entrada, mt.status, mt.cod_centermaq, mt.dtped_centermaq, ip.nome_impressora, ip.nserie FROM mov_unid_imagem mt LEFT JOIN impressoras ip on ip.id_impressora = mt.id_impressora WHERE mt.status = 'Solicitado';");
                                while ($row = $dados->fetchArray()) {
                                    echo "<tr>";
                                    $id_toner = $row['id_mov_unidimagem'];
                                    echo "<td>$id_toner</td>";
                    ...
                    <table class="table table-hover align-middle text-center table-bordered table-sm">
                        ...
                        <tbody>
                            <?php
                                ...
                                $dados = $db->query("SELECT mt.id_mov_unidimagem, mt.tecnico, mt.status, mt.cod_centermaq, mt.dtped_centermaq, mt.dt_saida, ip.nome_impressora, ip.nserie FROM mov_unid_imagem mt LEFT JOIN impressoras ip on ip.id_impressora = mt.id_impressora WHERE mt.status = 'Entregue Centermaq';");
                                while ($row = $dados->fetchArray()) {
                                    echo "<tr>";
                                    $id_toner = $row['id_mov_unidimagem'];
                                    echo "<td>$id_toner</td>";
        ...
        <script>
            ...
            function UsoToner(id_toner) {
                var input_id_toner = document.getElementById('id_drum_usado');
